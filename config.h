...
static const Key keys[] = {
    ...
    { MODKEY,                       XK_b,      spawn,          SHCMD("xs-blue.sh") },
    { MODKEY,                       XK_r,      spawn,          SHCMD("rofi -show run") },
    { MODKEY,                       XK_e,      spawn,          SHCMD("xs-power-menu.sh") },
    { MODKEY,                       XK_f,      spawn,          SHCMD("firefox") },
    { MODKEY|ShiftMask,             XK_p,      spawn,          SHCMD("spotify") },
    { MODKEY|ShiftMask,             XK_l,      spawn,          SHCMD("xs-lock-screen.sh") },
    //{ MODKEY,                       XK_l,      spawn,          SHCMD("xs-cd-term.sh $XDG_DATA_HOME/xscripts.d/dirs_latex.txt latex 2") },
    { MODKEY,                       XK_c,      spawn,          SHCMD("xs-cd-term.sh $XDG_DATA_HOME/xscripts.d/dirs_code.txt code 2") },

    { 0,	 						XK_Print,  spawn,		   SHCMD("xs-screenshot.sh all")},
	{ ShiftMask,					XK_Print,  spawn,		   SHCMD("xs-screenshot.sh select")},
	{ MODKEY,						XK_Print,  spawn,		   SHCMD("xs-screenshot.sh single")},
